...
format_gt(tbl_gt = iris_gt, zoom = 1)
```
...
format_gt(tbl_gt = iris_gt, zoom = 1, dpi = 500)
```
...
gt::gtsave(
  data = iris_gt,
  filename = "iris_gt.docx",
  path = here::here("gt_tables")
  )
```
